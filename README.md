# Gemini 2.0 멀티모달 프롬프트 실습

# 목표

Gemini 2.0의 멀티모달 기능을 몇가지 시나리오로 손쉽게 테스트해 봅니다.:
...
<table>
  <thead>
    <tr>
      <th><strong>asia-northeast1-docker.pkg.dev/sandbox-373102/education/prompt_tester:latest</strong></th>
    </tr>
  </thead>
  <tbody>
  </tbody>
